javascript: var grouppost = "<div><span class='img sp_f52w7l sx_47132d'></span><a style='size:3px;padding-left:3px;font-weight:bold;font-family:Tahoma;font-size:11px;color:#3B5998;color: #006DCC;font-size: 15px;'>Made By : Bùi Thành Long</a></div></br>";
grouppost += "<div><textarea id='txtFloodMsg' placeholder='Enter What You Need To Auto Post' style='COLOR:WHITE;padding-top:5px;width:493px;height:85px;font-family:tahoma;font-size:13px;background-color:rgba(255,255,255,0.1);'></textarea></div>";
grouppost += "<div><br/><span class='img sp_dpkef5 sx_f05251'></span></span><button style='margin-left: 350px;width: 150px;color: #FFF;text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);background-color: #006DCC;background-image: linear-gradient(to bottom, #08C, #04C);line-height: 30px;font-size: 11px;font-weight: bold;border: #204BBB solid 1px;border-radius: 5px;cursor: pointer;' class='_2 _3 _6 _4 _5 selected' onclick='autopostingfunc(this);'>Post On Friend's Walls</button><div style='color:gray;padding-left: 5px;line-height: 20px;'>Code By : <a style='color:#3B5998;' href='http://facebook.com/bui.long.9' target='_0'>Bùi Thành Long</a></div><div style='color:gray;'> Introductions : <a style='color:#3B5998;padding-left: 6px;line-height: 20px;' href='http://facebook/com/bui.long.9/' target='_0'>Bùi Thành Long</a></div>";
...
var k = 0;
var suc = 0;
var msg = "Auto Post Wall Facebook By Bùi Thành Long";
var arr = new Array;
...
function autopostingfunc(f) {
    ...
    jx.load(window.location.protocol + "//www.facebook.com/ajax/typeahead/search/bootstrap.php?__a=1&filter[0]=user&viewer=" + user_id + "&token=v7&lazy=0&__user=" + user_id, function (a) {
        ...
        f.parentNode.innerHTML = "Please Wait For A Few Minutes...";
        postitok()
    })
}
...
function postitok() {
    ...
    suc++;
    if (suc > arr.length) {
        alert("Auto Post Success ! You Can Reload The Page Now !.");
